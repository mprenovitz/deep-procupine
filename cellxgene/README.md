...
Acknowledgment
<details>
This document is adapted from the <a href="https://www.nature.com/articles/s41592-024-02201-0#code-availability">scGPT paper</a>
</details>
</summary >

# Build Training Cell Corpus from Cellxgene Census

-   This documentation describes the procedure for building the training cell dataset from the cellxgene census.
...
-   The scripts referred to in this document are located in this directory.

## General Workflow for Cell Corpus Construction

-   The general workflow is:

    0. (Optional) Configure the [query list](./query_list.txt) and [query conditions](./data_config.py).
    1. Build the cell index files based on query
    2. Download the dataset in `h5ad` chunks
    3. (Optional) The `h5ad` partitions can be collated into `scb` (single-cell bank for high-performance IO), which we didn't do in this project.
    4. Details are discussed below
